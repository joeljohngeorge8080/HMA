...
const DEFAULT_CATEGORIES = [
  ...
  },
  {
    id: CAT_IDS.INTERNET,
    name: 'Internet',
    description: 'Broadband and data services',
    is_active: true,
    created_at: SEED_TS,
    updated_at: SEED_TS,
  },
  {
    id: CAT_IDS.ELECTRICITY,
    name: 'Electricity',
    description: 'Electricity bills (KSEB)',
    is_active: true,
    created_at: SEED_TS,
    updated_at: SEED_TS,
  },
  {
    id: CAT_IDS.WATER_BILL,
    name: 'Water Bill',
    description: 'Water utility (KWA)',
    is_active: true,
    created_at: SEED_TS,
    updated_at: SEED_TS,
  },
  {
    id: CAT_IDS.STATIONERY,
    name: 'Stationery',
  ...
  },
  {
    ...
    description: 'Software subscriptions and AMC',
    is_active: true,
    created_at: SEED_TS,
    updated_at: SEED_TS,
  },
  ...
  {
    id: CAT_IDS.TELEPHONE,
    name: 'Telephone',
    description: 'Landline and communication',
    is_active: true,
    created_at: SEED_TS,
    updated_at: SEED_TS,
  },
...
// Same shape as _makeExp, but for an arbitrary month/year — used for the
// March/April/May 2026 ledgers imported from "hr and admin expenses - Sheet1.csv".
const _makeExpDated = (
  month,
  year,
  catId,
  ...
  const hasActual = actual !== null && actual !== undefined
  const status = statusOverride || (hasActual && a > 0 ? 'Paid' : 'Pending')
  const ts = `${year}-${String(month).padStart(2, '0')}-01T00:00:00.000Z`
  return {
    id: uid(),
    category_id: catId,
    expense_name: name,
...
const DEFAULT_EXPENSES = [
  ...
  _makeExp(
    CAT_IDS.SOFTWARE,
    'Tally Software Renewal',
    'Annually',
    1333,
    null,
    'Vendor: VRS Infosystems',
  ),
  _makeExp(
    CAT_IDS.AMC,
    'CAMC Computer Hardware',
    'Quarterly',
    1250,
    null,
    'Vendor: M/s Armtech Computer Services',
  ),
  ...
  _makeExp(
    CAT_IDS.MISCELLANEOUS,
    'Financial Consultant',
    'Monthly',
    108000,
    null,
    'Vendor: Pradeep Kumar Cost Accountant',
  ),
  _makeExp(
    CAT_IDS.MISCELLANEOUS,
    'Accounts Assistance',
...
// March / April / May 2026 — sourced from "docs/hr and admin expenses - Sheet1.csv"
// (HR EXPENSE BOOKING + ADMIN EXPENSE BOOKING sections for each month).
// The per-project allocation columns in that sheet are skipped here — those are
// computed automatically by localOrgPool's HR Pool distribution instead.
const MARCH_2026_EXPENSES = [
  _makeExpDated(
    3,
    2026,
    CAT_IDS.MAINTENANCE,
  ...
  _makeExpDated(3, 2026, CAT_IDS.TELEPHONE, 'Land Line', 'Monthly', 2000, 1979, 'Vendor: BSNL'),
  _makeExpDated(
    3,
    2026,
    CAT_IDS.ELECTRICITY,
  ...
  _makeExpDated(3, 2026, CAT_IDS.WATER_BILL, 'Water Bill', 'Monthly', 8000, null, 'Vendor: KWA'),
  _makeExpDated(
    3,
    2026,
    CAT_IDS.AMC,
  ...
  _makeExpDated(3, 2026, CAT_IDS.AMC, 'AC AMC', 'Quarterly', 3000, null, 'Vendor: Nu Aire'),
  _makeExpDated(3, 2026, CAT_IDS.MAINTENANCE, 'Repair & Maintenance', 'Monthly', 4167, null, null),
  _makeExpDated(3, 2026, CAT_IDS.SOFTWARE, 'Microsoft 365', 'Annually', 583, null, null),
  _makeExpDated(
    3,
    2026,
    CAT_IDS.AMC,
    'Photocopier (Admin & DVP)',
    'Monthly',
    5000,
    2671,
    'Vendor: Asterisk',
...
const APRIL_2026_EXPENSES = [
  ...
  // Oval Blue Technologies' "Photocopier HR" line first appears this month but has no
  // monthly average / actual figure yet in the sheet — first real figures land in May.
  _makeExpDated(
    4,
    2026,
    CAT_IDS.HOUSE_RENT,
  ...
  _makeExpDated(4, 2026, CAT_IDS.TELEPHONE, 'Land Line', 'Monthly', 2000, 1976, 'Vendor: BSNL'),
  _makeExpDated(
    4,
    2026,
    CAT_IDS.ELECTRICITY,
  ...
  _makeExpDated(4, 2026, CAT_IDS.WATER_BILL, 'Water Bill', 'Monthly', 8000, null, 'Vendor: KWA'),
  _makeExpDated(
    4,
    2026,
    CAT_IDS.AMC,
  ...
  _makeExpDated(4, 2026, CAT_IDS.AMC, 'AC AMC', 'Quarterly', 3000, null, 'Vendor: Nu Aire'),
  _makeExpDated(4, 2026, CAT_IDS.MAINTENANCE, 'Repair & Maintenance', 'Monthly', 4167, null, null),
  _makeExpDated(4, 2026, CAT_IDS.SOFTWARE, 'Microsoft 365', 'Annually', 583, null, null),
  _makeExpDated(
    4,
    2026,
    CAT_IDS.AMC,
    'Photocopier (Admin & CEO)',
    'Monthly',
    5000,
    2950,
    'Vendor: Asterisk',
...
const MAY_2026_EXPENSES = [
  ...
  _makeExpDated(5, 2026, CAT_IDS.TELEPHONE, 'Land Line', 'Monthly', 2000, 1980, 'Vendor: BSNL'),
  _makeExpDated(
    5,
    2026,
    CAT_IDS.ELECTRICITY,
  ...
  _makeExpDated(5, 2026, CAT_IDS.WATER_BILL, 'Water Bill', 'Monthly', 8000, null, 'Vendor: KWA'),
  _makeExpDated(
    5,
    2026,
    CAT_IDS.AMC,
  ...
  _makeExpDated(5, 2026, CAT_IDS.AMC, 'AC AMC', 'Quarterly', 3000, null, 'Vendor: Nu Aire'),
  _makeExpDated(5, 2026, CAT_IDS.MAINTENANCE, 'Repair & Maintenance', 'Monthly', 4167, null, null),
  _makeExpDated(5, 2026, CAT_IDS.SOFTWARE, 'Microsoft 365', 'Annually', 583, null, null),
  _makeExpDated(
    5,
    2026,
    CAT_IDS.AMC,
  ...
  update(id, patch) {
    ...
    if (patch.name) {
      const conflict = all.find(
        (c) => c.name.toLowerCase() === patch.name.toLowerCase() && c.id !== id,
      )
...
const expenses = {
  ...
  create(data) {
    ...
    const variance = parseFloat(
      (parseFloat(data.actual_amount || 0) - parseFloat(data.planned_amount || 0)).toFixed(2),
    )
    const exp = {
      id: uid(),
  ...
  update(id, patch) {
    ...
    updated.variance = parseFloat(
      (parseFloat(updated.actual_amount) - parseFloat(updated.planned_amount)).toFixed(2),
    )
    all[idx] = updated
