...
import { cilCalendar, cilCash, cilPeople, cilBriefcase } from '@coreui/icons'
        ...
        <div className="d-flex flex-column gap-3 p-4">
          {stats.map((s) => (
            ...
            >
              ...
              >
                <CIcon icon={s.icon} style={{ width: 20, height: 20, color: s.color }} />
              </div>
              <div>
                <div
                  className="fw-bold"
                ...
                <div
                  ...
                  style={{ fontSize: '0.75rem', marginTop: 6, color: 'var(--cui-body-color)' }}
                >
                  {s.label}
                </div>
                <div
                  style={{ fontSize: '0.65rem', color: 'var(--cui-secondary-color)', marginTop: 2 }}
                >
                  {s.sublabel}
                </div>
              </div>
